# modified based on model.py, from Dr. Sairam
...
def unet(pretrained_weights=None, input_size=(225, 225, 1)):
    inputs = Input(input_size)
    # inputs = scipy.misc.imresize(input, (224, 224))
    inputs = resize(inputs, (224, 224))
